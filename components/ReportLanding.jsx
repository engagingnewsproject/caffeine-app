...
const ReportLanding = ({ 
  ...
  // });
	...
	const style = {
		...
		header: "text-center md:text-left text-xl font-bold text-brown tracking-wider",
		buttonLg: 'flex items-center justify-center gap-5 bg-brown w-full hover:bg-brown-dark text-white font-normal py-2 px-6 border border-brown rounded-xl',
		button: 'bg-sky-100 hover:bg-brown-light text-brown font-normal py-2 px-6 mt-4 border border-brown rounded-xl',
		systemWrap: 'text-xl font-extrabold text-brown tracking-wider mt-5'
	}
