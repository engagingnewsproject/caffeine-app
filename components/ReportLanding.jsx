...
const ReportLanding = ({ 
  ...
  // });
	...
	const style = {
		...
		buttonLg: 'flex items-center justify-center gap-5 bg-blue-600 w-full hover:bg-blue-600-dark text-white font-normal py-2 px-6 border border-blue-600 rounded-xl',
		button: 'bg-sky-100 hover:bg-blue-600 text-blue-600 font-normal py-2 px-6 mt-4 border border-blue-600 rounded-xl',
