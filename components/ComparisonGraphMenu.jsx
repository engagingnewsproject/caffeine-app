    ...
    <div className="flex justify-stretch lg:justify-between flex-wrap">
      <div className="flex justify-between items-center">
        ...
        {showCalendar == 0 ? 
          ...
          {!loaded &&
             <svg aria-hidden="true" className="ml-2 w-8 h-8 mr-2 text-gray-200 animate-spin dark:text-gray-600 fill-brown" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">	
