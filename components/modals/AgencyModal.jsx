...
const handleImageChange = (e) => {
  ...
  const deleteAdmin = () => {
    ...
    modal_form_add_agency: 'col-span-2 text-sm rounded-xl p-1 mb-5',
		...
		modal_form_button: 'bg-brown col-start-3 self-end hover:bg-blue-700 text-sm text-white font-semibold ml-1 py-2 px-6 rounded-md focus:outline-none focus:shadow-outline',
    ...
    modal_resend_button: "bg-brown col-start-3 self-end hover:bg-blue-700 text-sm text-white font-semibold ml-1 px-2 rounded-lg focus:outline-none focus:shadow-outline",
