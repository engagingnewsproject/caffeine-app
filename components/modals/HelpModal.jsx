        ...
        <div className="relative top-20 mx-auto p-5 border w-10/12 lg:w-6/12 shadow-lg rounded-md bg-white">
          <div className="flex flex-col overflow-y-auto bg-white h-auto rounded-2xl mt-4 lg:mt-autopy-10 px-10" onClick={(e) => { e.stopPropagation() }}>
            <div className="flex justify-between w-full mb-5">
              ...
              <h3 className="text-lg font-bold text-brown tracking-wider pt-2">Help and Documentation</h3>
            </div>

            <h3 className="text-lg font-bold text-brown tracking-wider pt-2">General</h3>
            ...
            <h3 className="text-lg font-bold text-brown tracking-wider pt-2">Overview</h3>
            ...
            <h3 className="text-lg font-bold text-brown tracking-wider pt-2">Comparison View</h3>
            ...
            <h3 className="text-lg font-bold text-brown tracking-wider pt-2">Tag System</h3>
            ...
            <h3 className="text-lg font-bold text-brown tracking-wider pt-2">Reports Section</h3>
            ...
            <h3 className="text-lg font-bold text-brown tracking-wider pt-2">Adding a New Report</h3>
